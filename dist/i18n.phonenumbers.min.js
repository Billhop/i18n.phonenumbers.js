...
return ra};B.ctor=B;B.ctor.h=B.prototype.h;
var C={1:"US AG AI AS BB BM BS CA DM DO GD GU JM KN KY LC MP MS PR SX TC TT VC VG VI".split(" "),7:["RU","KZ"],20:["EG"],27:["ZA"],30:["GR"],31:["NL"],32:["BE"],33:["FR"],34:["ES"],36:["HU"],39:["IT"],40:["RO"],41:["CH"],43:["AT"],44:["GB","GG","IM","JE"],45:["DK"],46:["SE"],47:["NO","SJ"],48:["PL"],49:["DE"],51:["PE"],52:["MX"],53:["CU"],54:["AR"],55:["BR"],56:["CL"],57:["CO"],58:["VE"],60:["MY"],61:["AU","CC","CX"],62:["ID"],63:["PH"],64:["NZ"],65:["SG"],66:["TH"],81:["JP"],82:["KR"],84:["VN"],
...
,"NA","NA"],,,[,,"NA","NA"],[,,"\\d{11}","\\d{11}",,,"12345678901"],1,,[,,"NA","NA"]],979:[,[,,"\\d{9}","\\d{9}",,,"123456789"],[,,"NA","NA",,,"123456789"],[,,"NA","NA",,,"123456789"],[,,"NA","NA"],[,,"\\d{9}","\\d{9}",,,"123456789"],[,,"NA","NA"],[,,"NA","NA"],[,,"NA","NA"],"001",979,"",,,,,,,1,[[,"(\\d)(\\d{4})(\\d{4})","$1 $2 $3",,"","",0]],,[,,"NA","NA"],,,[,,"NA","NA"],[,,"NA","NA"],1,,[,,"NA","NA"]]};function ua(){}ua.prototype.a=function(a){new a.b;throw Error("Unimplemented");};ua.prototype.b=function(a,b){if(11==a.b||10==a.b)return b instanceof q?b:this.a(a.j.prototype.h(),b);if(14==a.b||!a.i)return b;var c=a.j;if(c===String){if("number"==typeof b)return String(b)}else if(c===Number&&k(b)&&("Infinity"===b||"-Infinity"===b||"NaN"===b||/^-?[0-9]+$/.test(b)))return Number(b);return b};function va(){}n(va,ua);va.prototype.a=function(a,b){var c=new a.b;c.g=this;c.b=b;c.a={};return c};function D(){}n(D,va);D.prototype.b=function(a,b){return 8==a.b?!!b:ua.prototype.b.apply(this,arguments)};D.prototype.a=function(a,b){return D.ja.a.call(this,a,b)};function E(a,b){null!=a&&this.a.apply(this,arguments)}E.prototype.b="";E.prototype.set=function(a){this.b=""+a};E.prototype.a=function(a,b,c){this.b+=a;if(null!=b)for(var d=1;d<arguments.length;d++)this.b+=arguments[d];return this};function F(a){a.b=""}E.prototype.toString=function(){return this.b};function G(){q.call(this)}var wa;n(G,q);function H(){q.call(this)}var xa;n(H,q);function I(){q.call(this)}var ya;n(I,q);
G.prototype.h=function(){wa||(wa=A(G,{0:{name:"NumberFormat",ca:"i18n.phonenumbers.NumberFormat"},1:{name:"pattern",required:!0,c:9,type:String},2:{name:"format",required:!0,c:9,type:String},3:{name:"leading_digits_pattern",da:!0,c:9,type:String},4:{name:"national_prefix_formatting_rule",c:9,type:String},6:{name:"national_prefix_optional_when_formatting",c:8,type:Boolean},5:{name:"domestic_carrier_code_formatting_rule",c:9,type:String}}));return wa};G.ctor=G;G.ctor.h=G.prototype.h;
H.prototype.h=function(){xa||(xa=A(H,{0:{name:"PhoneNumberDesc",ca:"i18n.phonenumbers.PhoneNumberDesc"},2:{name:"national_number_pattern",c:9,type:String},3:{name:"possible_number_pattern",c:9,type:String},6:{name:"example_number",c:9,type:String},7:{name:"national_number_matcher_data",c:12,type:String},8:{name:"possible_number_matcher_data",c:12,type:String}}));return xa};H.ctor=H;H.ctor.h=H.prototype.h;
I.prototype.h=function(){ya||(ya=A(I,{0:{name:"PhoneMetadata",ca:"i18n.phonenumbers.PhoneMetadata"},1:{name:"general_desc",c:11,type:H},2:{name:"fixed_line",c:11,type:H},3:{name:"mobile",c:11,type:H},4:{name:"toll_free",c:11,type:H},5:{name:"premium_rate",c:11,type:H},6:{name:"shared_cost",c:11,type:H},7:{name:"personal_number",c:11,type:H},8:{name:"voip",c:11,type:H},21:{name:"pager",c:11,type:H},25:{name:"uan",c:11,type:H},27:{name:"emergency",c:11,type:H},28:{name:"voicemail",c:11,type:H},24:{name:"no_international_dialling",
...
"i"),Ka=/(\$\d)/,La=/\$NP/,Ma=/\$FG/,Na=/\$CC/,Oa=/^\(?\$1\)?$/;function Pa(a){var b=a.search(Ea);0<=b?(a=a.substring(b),a=a.replace(Ga,""),b=a.search(Fa),0<=b&&(a=a.substring(0,b))):a="";return a}function Qa(a){return 2>a.length?!1:M(Ja,a)}function Ra(a){return M(Ha,a)?N(a,Aa):N(a,K)}function Sa(a){var b=Ra(a.toString());F(a);a.a(b)}function Ta(){return ca(Object.keys(ta),function(a){return isNaN(a)})}
function N(a,b){for(var c=new E,d,f=a.length,e=0;e<f;++e)d=a.charAt(e),d=b[d.toUpperCase()],null!=d&&c.a(d);return c.toString()}function O(a){return null!=a&&isNaN(a)&&a.toUpperCase()in ta}function Q(a,b,c){if(0==t(b,2)&&r(b,5)){var d=x(b,5);if(0<d.length)return d}var d=x(b,1),f=R(b);if(0==c)return S(d,0,f,"");if(!(d in C))return f;a=T(a,d,U(d));b=Ua(b,a,c);f=Va(f,a,c);return S(d,c,f,b)}
function Wa(a,b,c){var d=x(b,1),f=R(b);if(!(d in C))return f;a=T(a,d,U(d));b=Ua(b,a,2);c=Va(f,a,2,c);return S(d,2,c,b)}function T(a,b,c){return"001"==c?V(a,""+b):V(a,c)}
function Xa(a,b,c){if(!O(c))return Q(a,b,1);var d=x(b,1),f=R(b);if(!(d in C))return f;if(1==d){if(null!=c&&0<=ba(C[1],c.toUpperCase()))return d+" "+Q(a,b,2)}else if(d==Ya(a,c))return Q(a,b,2);var e=V(a,c),g=x(e,11);c="";M(Ba,g)?c=g:r(e,17)&&(c=x(e,17));a=T(a,d,U(d));f=Va(f,a,1);b=Ua(b,a,1);return 0<c.length?c+" "+d+" "+f+b:S(d,1,f,b)}function R(a){var b=""+t(a,2);return r(a,4)&&t(a,4)?Array(x(a,8)+1).join("0")+b:b}
...
function db(a,b){return W(a,t(b,1))?W(a,t(b,5))?4:W(a,t(b,4))?3:W(a,t(b,6))?5:W(a,t(b,8))?6:W(a,t(b,7))?7:W(a,t(b,21))?8:W(a,t(b,25))?9:W(a,t(b,28))?10:W(a,t(b,2))?t(b,18)||W(a,t(b,3))?2:0:!t(b,18)&&W(a,t(b,3))?1:-1:-1}function V(a,b){if(null==b)return null;b=b.toUpperCase();var c=a.a[b];if(!c){c=ta[b];if(!c)return null;c=(new D).a(I.h(),c);a.a[b]=c}return c}function W(a,b){return M(x(b,3),a)&&M(x(b,2),a)}function eb(a,b){var c=cb(a,b);return fb(a,b,c)}
function fb(a,b,c){var d=x(b,1),f=T(a,d,c);if(!f||"001"!=c&&d!=Ya(a,c))return!1;a=R(b);return-1!=db(a,f)}function cb(a,b){if(!b)return null;var c=x(b,1);if(c=C[c])if(1==c.length)c=c[0];else a:{for(var d=R(b),f,e=c.length,g=0;g<e;g++){f=c[g];var h=V(a,f);if(r(h,23)){if(!d.search(t(h,23))){c=f;break a}}else if(-1!=db(d,h)){c=f;break a}}c=null}else c=null;return c}function U(a){return(a=C[a])?a[0]:"ZZ"}function Ya(a,b){var c=V(a,b);if(!c)throw"Invalid region code: "+b;return x(c,10)}
function gb(a,b){var c=V(a,b);if(!c)return null;c=x(c,12);return c.length?c=c.replace("~",""):null}function hb(a,b){return M(a,b)?0:b.search(a)?2:3}function ib(a,b){var c=x(t(a,1),3);return 2==hb(c,b)}function jb(a){var b=X,c=R(a);a=x(a,1);if(!(a in C))return 1;b=x(t(T(b,a,U(a)),1),3);return hb(b,c)}function kb(a,b){var c=a.toString();if(!c.length||"0"==c.charAt(0))return 0;for(var d,f=c.length,e=1;3>=e&&e<=f;++e)if(d=parseInt(c.substring(0,e),10),d in C)return b.a(c.substring(e)),d;return 0}
function lb(a,b,c,d,f){if(!a.length)return 0;a=new E(a);var e;b&&(e=t(b,11));null==e&&(e="NonMatch");var g=a.toString();if(g.length)if(L.test(g))g=g.replace(L,""),F(a),a.a(Ra(g)),e=1;else{g=new RegExp(e);Sa(a);e=a.toString();if(e.search(g))e=!1;else{var g=e.match(g)[0].length,h=e.substring(g).match(Da);h&&null!=h[1]&&0<h[1].length&&"0"==N(h[1],K)?e=!1:(F(a),a.a(e.substring(g)),e=!0)}e=e?5:20}else e=20;d&&u(f,6,e);if(20!=e){if(2>=a.b.length)throw"Phone number too short after IDD";if(c=kb(a,c))return u(f,
1,c),c;throw"Invalid country calling code";}if(b&&(e=x(b,10),g=""+e,h=a.toString(),!h.lastIndexOf(g,0))){var m=new E(h.substring(g.length)),h=t(b,1),g=new RegExp(x(h,2));mb(m,b,null);b=m.toString();h=x(h,3);if(!M(g,a.toString())&&M(g,b)||3==hb(h,a.toString()))return c.a(b),d&&u(f,6,10),u(f,1,e),e}u(f,1,0);return 0}
...
e=f.toString();if(!(O(c)||null!=e&&0<e.length&&L.test(e)))throw"Invalid country calling code";e=new B;d&&u(e,5,b);a:{b=f.toString();g=b.search(Ia);if(0<=g&&Qa(b.substring(0,g)))for(var h=b.match(Ia),m=h.length,v=1;v<m;++v)if(null!=h[v]&&0<h[v].length){F(f);f.a(b.substring(0,g));b=h[v];break a}b=""}0<b.length&&u(e,3,b);b=V(a,c);g=new E;h=0;m=f.toString();try{h=lb(m,b,g,d,e)}catch(P){if("Invalid country calling code"==P&&L.test(m)){if(m=m.replace(L,""),h=lb(m,b,g,d,e),!h)throw P;}else throw P;}h?(f=
U(h),f!=c&&(b=T(a,h,f))):(Sa(f),g.a(f.toString()),null!=c?(h=x(b,10),u(e,1,h)):d&&z(e,6));if(2>g.b.length)throw"The string supplied is too short to be a phone number";b&&(a=new E,c=new E(g.toString()),mb(c,b,a),ib(b,c.toString())||(g=c,d&&u(e,7,a.toString())));d=g.toString();a=d.length;if(2>a)throw"The string supplied is too short to be a phone number";if(17<a)throw"The string supplied is too long to be a phone number";if(1<d.length&&"0"==d.charAt(0)){u(e,4,!0);for(a=1;a<d.length-1&&"0"==d.charAt(a);)a++;
1!=a&&u(e,8,a)}u(e,2,parseInt(d,10));return e}function ob(a,b){var c=V(a,cb(a,b));if(!c)return!0;var d=R(b);return!W(d,t(c,24))}function M(a,b){var c="string"==typeof a?b.match("^(?:"+a+")$"):b.match(a);return c&&c[0].length==b.length?!0:!1};function pb(a){this.ea=RegExp("\u2008");this.s="";this.o=new E;this.w="";this.i=new E;this.l=new E;this.j=!0;this.$=this.u=this.ga=!1;this.aa=J.a();this.ia=this.ha=this.v=0;this.b=new E;this.ba=!1;this.m="";this.a=new E;this.f=[];this.fa=a;this.g=qb(this,this.fa)}var rb=new I;u(rb,11,"NA");
var sb=/\[([^\[\]])*\]/g,tb=/\d(?=[^,}][^,}])/g,ub=RegExp("^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\\[\\]/~\u2053\u223c\uff5e]*(\\$\\d[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\\[\\]/~\u2053\u223c\uff5e]*)+$"),vb=/[- ]/;function qb(a,b){var c=O(b)?Ya(a.aa,b):0;return(c=V(a.aa,U(c)))?c:rb}
function wb(a){for(var b=a.f.length,c=0;c<b;++c){var d=a.f[c],f=x(d,1);if(a.w==f)return!1;var e;e=a;var g=d,h=x(g,1);if(-1!=h.indexOf("|"))e=!1;else{h=h.replace(sb,"\\d");h=h.replace(tb,"\\d");F(e.o);var m;m=e;var g=x(g,2),v="999999999999999".match(h)[0];v.length<m.a.b.length?m="":(m=v.replace(new RegExp(h,"g"),g),m=m.replace(RegExp("9","g"),"\u2008"));0<m.length?(e.o.a(m),e=!0):e=!1}if(e)return a.w=f,a.ba=vb.test(t(d,4)),a.v=0,!0}return a.j=!1}
...
function Cb(a){var b=a.a.toString(),c=0,d;1!=t(a.g,10)?d=!1:(d=a.a.toString(),d="1"==d.charAt(0)&&"0"!=d.charAt(1)&&"1"!=d.charAt(1));d?(c=1,a.b.a("1").a(" "),a.u=!0):r(a.g,15)&&(d=new RegExp("^(?:"+t(a.g,15)+")"),(d=b.match(d))&&null!=d[0]&&0<d[0].length&&(a.u=!0,c=d[0].length,a.b.a(b.substring(0,c))));F(a.a);a.a.a(b.substring(c));return b.substring(0,c)}
function zb(a){var b=a.l.toString(),c=new RegExp("^(?:\\+|"+t(a.g,11)+")");return(c=b.match(c))&&null!=c[0]&&0<c[0].length?(a.u=!0,c=c[0].length,F(a.a),a.a.a(b.substring(c)),F(a.b),a.b.a(b.substring(0,c)),"+"!=b.charAt(0)&&a.b.a(" "),!0):!1}function Ab(a){if(!a.a.b.length)return!1;var b=new E,c=kb(a.a,b);if(!c)return!1;F(a.a);a.a.a(b.toString());b=U(c);"001"==b?a.g=V(a.aa,""+c):b!=a.fa&&(a.g=qb(a,b));a.b.a(""+c).a(" ");a.m="";return!0}
...
e,!1));break b}catch(v){}h=!1}if(h)f=d;else if(h=V(f,e),e=R(c),h=Za(w(h,19)||[],e))if(e=x(h,4),g=e.indexOf("$1"),0>=g)f=d;else if(e=e.substring(0,g),e=N(e,K),e.length)if(h=h.clone(),z(h,4),e=[h],h=x(c,1),d=R(c),h in C){f=T(f,h,U(h));if(g=Za(e,d))e=g.clone(),g=x(g,4),0<g.length&&(m=x(f,12),0<m.length?(g=g.replace(La,m).replace(Ma,"$1"),u(e,4,g)):z(e,4)),d=$a(d,e,2);f=Ua(c,f,2);f=S(h,2,d,f)}else f=d;else f=d;else f=d}else f=d}c=x(c,5);null!=f&&0<c.length&&(h=N(f,za),d=N(c,za),h!=d&&(f=c));c=f}else c=
